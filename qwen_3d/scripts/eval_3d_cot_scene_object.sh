...
gpu=0
lora_type=merger_save_all_lora-gradient_1_gpu_4-v4-3.31-scene_object-cot-text_cross_attention
norm_type=none
grid_n=7
...
test_json=processed_data_with_depth_npy/test/test_data_multi_view_cot_scene_object.json
...
output_dir=output_3d/${lora_type}/test_results-right_param-new_T-top_p-sampled-scene_object-${output_d}
# 获取当前时间戳
timestamp=$(date +"%Y%m%d_%H%M%S")
output_name=${lora_type}-scene_object-right_param-new_T-top_p-test-sampled-test_result-${timestamp}
