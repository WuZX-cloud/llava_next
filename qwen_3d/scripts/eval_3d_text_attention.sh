...
gpu=3
lora_type=merger_save_all_lora-gradient_1_gpu_4-v4-3.31-text_cross_attention-none-sigma-0
norm_type=none
grid_n=7
...
test_json=processed_data_with_depth_npy/test/test_data_multi_view_follow.json
...
output_dir=output_3d/${lora_type}/test_results-multi-view-no-sample-${output_d}
# 获取当前时间戳
timestamp=$(date +"%Y%m%d_%H%M%S")
output_name=${lora_type}-test_result-${timestamp}
