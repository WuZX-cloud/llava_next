...
output_dir=output/no-finetune-cot/test-new_T-top_p-sampled       # output/merger_save_all_lora-finetune-gradient_1_gpu_4-cot/test
output_name=cot-scene_object-test-new_T-top_p-sampled


CUDA_VISIBLE_DEVICES=1 python -m qwen_vl_finetune.eval.eval_multi \
            --test_data ${test_data} \
