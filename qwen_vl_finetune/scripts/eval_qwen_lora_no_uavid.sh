...
# lora_type=merger_save_all_lora-new_label-finetune_no_uavid-gradient_1_gpu_4
lora_type=merger_save_all_lora-new_label-finetune_no_uavid2-gradient_1_gpu_4
...
output_dir=./output/${lora_type}/test_results-no-sample2-shuffled-test
...
CUDA_VISIBLE_DEVICES=2 python -m qwen_vl_finetune.eval.eval_multi \
            --test_data ${test_data} \
