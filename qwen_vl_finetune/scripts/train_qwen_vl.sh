...
OUTPUT_DIR="./output/${lora_type}-new_label-finetune-gradient_1_gpu_4-get_param_data"
...
# 使用DeepSpeed启动
CUDA_VISIBLE_DEVICES=4,5 deepspeed qwen_vl_finetune/train/train_multimodal.py \
