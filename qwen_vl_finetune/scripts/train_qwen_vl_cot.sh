...
# TRAIN_DATA="./processed_data_with_depth_npy/train/train_data_multi_view_follow.json"  # 你的训练数据
TRAIN_DATA="./processed_data_with_depth_npy/train/train_data_multi_view_cot_scene_object.json"  # 你的训练数据
VIDEO_MAPPING="./processed_data_with_depth_npy/total_info_processed.json"  # video到图片路径的映射
OUTPUT_DIR="./output/${lora_type}-finetune-gradient_1_gpu_4-cot-scene_object"
