...
TRAIN_DATA="./processed_data_with_depth_npy/train/train_data_multi_view_follow_no_vision.json"  # 你的训练数据
VIDEO_MAPPING="./processed_data_with_depth_npy/total_info_processed.json"  # video到图片路径的映射
OUTPUT_DIR="./output/${lora_type}-new_label-finetune_no_vision-gradient_1_gpu_4"
