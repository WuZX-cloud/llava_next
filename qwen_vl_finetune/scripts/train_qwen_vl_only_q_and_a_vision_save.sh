...
# NUM_GPUS=1
lora_type=visual_save_all_lora
eval=False


shuffle_uav_id=False  # 如果要去掉uav id，打乱顺序，消除指代
...
TRAIN_DATA="./processed_data_with_depth_npy/train/train_data_multi_view.json"  # 你的训练数据
VIDEO_MAPPING="./processed_data_with_depth_npy/total_info_processed.json"  # video到图片路径的映射
OUTPUT_DIR="./output/${lora_type}-new_label-finetune_only_q_and_a-gradient_128_gpu_4"
...
GRADIENT_ACCUMULATION=128   # 实际batch_size = 1 * 8 * 4 = 32
LEARNING_RATE=1e-4
MAX_LENGTH=4096
